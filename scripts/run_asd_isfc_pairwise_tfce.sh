#!/bin/bash
# Run ISFC Pairwise Bootstrap TFCE for ASD group — one job at a time
...
RESULT_BASE="/Users/tongshan/Documents/TemporalIntegration/result/ASD/ISFC/bootstrap/tfce/pairwise"
N_PERMS=1000
...
for seed_info in "${SEEDS[@]}"; do
    ...
    for condition in "${CONDITIONS[@]}"; do
        ...
        echo ""
        echo "============================================"
        echo "  ISFC Pairwise Bootstrap TFCE: $seed_name / $condition"
